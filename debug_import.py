...
print("detect_code_changes args:", prfectbot.gitutils.detect_code_changes.__code__.co_varnames[:prfectbot.gitutils.detect_code_changes.__code__.co_argcount]) 